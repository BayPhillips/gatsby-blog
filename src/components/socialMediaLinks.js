  ...
  render() {
    return (
      <ul className="uk-iconnav uk-margin-auto" style={{ width: '70%' }}>
        <li>
          <a
            href="https://www.github.com/bayphillips"
            target="_blank"
        ...
        <li>
          <a
            href="https://www.facebook.com/bay.phillips"
            target="_blank"
            rel="noopener noreferrer"
            className="uk-icon-link"
        ...
        <li>
          <a
            href="https://www.twitter.com/bayphillips"
            target="_blank"
            rel="noopener noreferrer"
            className="uk-icon-link"
        ...
        <li>
          <a
            href="https://www.instagram.com/bayphillips"
            target="_blank"
            rel="noopener noreferrer"
            className="uk-icon-link"
